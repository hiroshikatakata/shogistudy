...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var createImageHTML = function createImageHTML(blob) {
    var html = '<div id="new-image2"><img src=${blob} width="114" height="80" ></div>';
    var textbox_element = document.getElementById('new_image');
    console.log("HELP3");
    textbox_element.appendChild(html);
...
/******/ });
//# sourceMappingURL=application-92b34dec6c9047bc3531.js.map