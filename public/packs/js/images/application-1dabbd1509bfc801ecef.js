...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var createImageHTML = function createImageHTML(blob) {
    var html = '<div id="new-image"><img src=${blob} width="114" height="80" ></div>';
    $('.outer_new_board_createbotton').before(html);
    console.log("HELP3");
...
/******/ });
//# sourceMappingURL=application-1dabbd1509bfc801ecef.js.map